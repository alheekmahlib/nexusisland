...
| ☐ | 2.3 | **تعريب كامل + RTL** | تحسين بنيوي | `.xcstrings` String Catalog + دعم RTL؛ نستخدم skill `arabic-bidi-fix` |

**تفاصيل 2.1**: إشعار قبل كل صلاة بدقائق قابلة للضبط، عرض الصلاة القادمة في الـ pill، اتجاه القبلة.
**تفاصيل 2.2**: عرض "١٥ محرم ١٤٤٨هـ" بجانب التاريخ الميلادي، إبراز المناسبات الإسلامية.
**تفاصيل 2.3**: كل الواجهات + الإعدادات + الأذكار.
