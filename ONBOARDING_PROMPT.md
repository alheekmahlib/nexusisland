...
Rebuild the entire onboarding flow for **NexusIsland** (macOS SwiftUI app). The onboarding is a **standalone window** — not a native macOS-feeling window. Think of it as a **compact, floating A4-ish black card** centered on screen. No title bar chrome. No toolbar. Just a clean, dark, self-contained panel with rounded corners and zero native window decorations visible.
...
- **"Welcome to NexusIsland"** — size 22, weight .semibold, text primary color.
...
|---|---|---|
| **Screen Recording** | `display` | "Lets NexusIsland detect your active workspace and render over the notch." |
...
| **Notifications** | `bell.badge` | "Mirror system notifications in the Nexus Island." |
...
#### 1. Section Header
- **"How to use NexusIsland"** — size 34, weight .semibold, text primary. Centered.
...
- **Visual**: An animated illustration showing a miniature Nexus Island capsule (dark pill shape, ~180×36) with a **horizontal arrow animation**:
